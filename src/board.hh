...
////////////////////////////////////////////////////////////////////////////////
inline bool Board::isInBound(dim_type position) noexcept
{
...
////////////////////////////////////////////////////////////////////////////////
inline bool Board::isInBound(dim_type row, dim_type column) noexcept
{
...
////////////////////////////////////////////////////////////////////////////////
inline Board Board::makeMoveCopy(const PieceMove &pieceMove) const
{
  Board board(*this);
...
// get the last move
////////////////////////////////////////////////////////////////////////////////
inline PieceMove Board::lastMove() const noexcept
{
  return mLastMove;
}
...
////////////////////////////////////////////////////////////////////////////////
inline Board::iterator Board::begin() const noexcept
{
...
////////////////////////////////////////////////////////////////////////////////
inline Board::iterator Board::end() const noexcept
{
...
////////////////////////////////////////////////////////////////////////////////
inline PieceColor Board::colorToMove() const noexcept
{
  return mColor;
}
...
////////////////////////////////////////////////////////////////////////////////
inline Board Board::moveCopy(const PieceMove &pieceMove) const
{
  Board board(*this);
...
////////////////////////////////////////////////////////////////////////////////
inline bool operator==(const Board &board1, const Board &board2) noexcept
{
