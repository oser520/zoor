...
public:
  ...
  //! @throw Never throws.
  BoardInfo&
  operator=(const BoardInfo& info) noexcept = default;

  //! @brief Default move assignment.
  //! @param info The @c BoardInfo to move.
  //! @throw Never throws.
  BoardInfo&
  operator=(BoardInfo&& info) noexcept = default;
  ...
  bool
  rookA1() const noexcept;

  BoardInfo&
  rookA1On() noexcept;

  bool
  rookH1() const noexcept;

  BoardInfo&
  rookH1On() noexcept;

  bool
  wkMoved() const noexcept;

  BoardInfo&
  wkMovedOn() noexcept;

  bool
  wkCheck() const noexcept;

  BoardInfo&
  wkCheckSet(bool value) noexcept;

  bool
  wkMate() const noexcept;

  BoardInfo&
  wkMateOn() noexcept;

  bool
  wkCastle() const noexcept;

  bool
  wkCastleLong() const noexcept;
  ...
  bool
  rookA8() const noexcept;

  BoardInfo&
  rookA8On() noexcept;

  bool
  rookH8() const noexcept;

  BoardInfo&
  rookH8On() noexcept;

  bool
  bkMoved() const noexcept;

  BoardInfo&
  bkMovedOn() noexcept;

  bool
  bkCheck() const noexcept;

  BoardInfo&
  bkCheckSet(bool value) noexcept;

  bool
  bkMate() const noexcept;

  BoardInfo&
  bkMateOn() noexcept;

  bool
  bkCastle() const noexcept;

  bool
  bkCastleLong() const noexcept;
