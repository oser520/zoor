...
//
// @brief piececode_t represents a chess piece and its color
//
...
/// @details The PieceColor can be logically ORed with a PiceCode to make a piece
/// have color.
///
...
///
/// @brief A mask to get the @c PieceCode and @c PieceColor from a bit pattern that
/// contains both.
///
...
///
/// @brief piecevalue_t represents the value of a chess piece.
///
using piecevalue_t = short;

///
/// @brief Represents the value of a piece.
///
...
///
PieceCode
getPieceCode(piececode_t code) noexcept;
...
///
PieceColor
getPieceColor(piececode_t code) noexcept;
...
///
bool
isPawn(piececode_t code) noexcept;
...
///
bool
isPawn(PieceCode piece) noexcept;
...
///
bool
isKnight(piececode_t code) noexcept;
...
///
bool
isKnight(PieceCode piece) noexcept;
...
///
bool
isBishop(PieceCode piece) noexcept;
...
///
bool
isRook(piececode_t code) noexcept;
...
///
bool
isRook(PieceCode piece) noexcept;
...
///
bool
isQueen(piececode_t code) noexcept;
...
///
bool
isQueen(PieceCode piece) noexcept;
...
///
bool
isKing(piececode_t code) noexcept;
...
///
bool
isKing(PieceCode piece) noexcept;
...
///
bool
isWhite(piececode_t code) noexcept;
...
///
bool
isWhite(PieceColor color) noexcept;
...
///
bool
isBlack(piececode_t code) noexcept;
...
///
bool
isBlack(PieceColor color) noexcept;
...
///
bool
isPieceNone(piececode_t code) noexcept;
...
///
bool
isPieceNone(PieceCode piece) noexcept;
...
///
bool
isColorNone(piececode_t code) noexcept;
...
///
bool
isColorNone(PieceColor color) noexcept;
...
///
bool
isSamePiece(piececode_t code, PieceCode piece) noexcept;
...
///
bool
isSameColor(piececode_t code, PieceColor color) noexcept;

///
/// @brief Output operator for a @c PieceCode.
/// @details The @c PieceCode names are:
/// @li NONE
/// @li PAWN
/// @li KNIGHT
/// @li BISHOP
...
///
std::ostream&
operator<<(std::ostream &os, const PieceCode &piece);

///
/// @brief Output operator for a @c PieceColor.
/// @details The @c PieceColor names are:
/// @li NONE
/// @li WHITE
/// @li BLACK
/// @param os The output stream.
...
///
std::ostream&
operator<<(std::ostream &os, const PieceColor &color);
...
///
piececode_t
operator|(const PieceColor &color, const PieceCode &piece) noexcept;
...
///
PieceColor
operator~(const PieceColor &color) noexcept;
...
///
const char*
shortStringCode(piececode_t code) noexcept;
